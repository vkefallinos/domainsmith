...
export interface Agent {
  ...
  systemPrompt: string;
  /** Slash actions that trigger flows for this agent */
...
/**
 * Parameters passed to a slash action
 */
export interface SlashActionParameters {
  /** Parameter key-value pairs */
  [key: string]: string;
}

/**
 * Slash action metadata attached to a user message
 */
export interface MessageSlashAction {
  /** The action trigger (e.g., "generate") */
  action: string;
  /** ID of the agent this action belongs to */
  agentId: string;
  /** ID of the flow this action triggers */
  ...
  parameters: SlashActionParameters;
}

/**
 * Structured output generated by a slash action
...
export interface Message {
  ...
  timestamp: string;
  /** Slash action metadata (present for user messages using slash actions) */
